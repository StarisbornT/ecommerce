    ...
    <header>
        ...
        <div class="wsus__mini_cart">
            ...
            <ul class="mini_cart_wrapper">
                ...
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>Variant total: {{$setting->currency_icon}}{{$sidebarProduct->options->variants_total}}</small> <br>
            ...
            <div class="mini_cart_action {{Cart::content()->count() == 0 ? 'd-none': ''}}">
                ...
                <h5>sub total <span id="mini_cart_subtotal">{{$setting->currency_icon}}{{getCartTotal()}}</span></h5>
