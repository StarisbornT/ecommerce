                ...
                <div class="row">
                            ...
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        @foreach ($product->productImageGallery as $pro)
                                        <li><img class="zoom ing-fluid w-100" src="{{asset($pro->image)}}" alt="product"></li>
                    ...
                    <div class="col-xl-5 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            <p class="wsus__stock_area"><span class="stock_out bg-danger text-white p-1">Stocked out</span>({{$product->qty}} Item)</p>
                            @endif
                            @if (checkDiscount($product))
                            <h4>{{$setting->currency_icon}}{{$product->offer_price}}<del>{{$setting->currency_icon}}{{$product->price}}</del></h4>
                            @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-sm-6">
                                            ...
                                            <select class="select_2" name="variant_items[]">
                                                ...
                                                <option value="{{$item->id}}" {{$item->is_default == 1 ? 'selected' : ''}}>{{$item->name}} ({{$setting->currency_icon}}{{$item->price}})</option>
                                                @endif
                                                @endforeach
