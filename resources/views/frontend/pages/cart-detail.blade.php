            ...
            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr class="d-flex">
                                        ...
                                        <td class="wsus__pro_name">
                                            <p>{!! $item->name !!}</p>
                                            @foreach ($item->options->variant_items as $key => $variant)
                                        ...
                                        <td class="wsus__pro_tk">
                                            <h6 id="{{$item->rowId}}">{{$setting->currency_icon.($item->price + $item->options->variant_total) * $item->qty}}</h6>
                                        </td>
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <p class="total"><span>total:</span> <span id="cart_total">{{$setting->currency_icon}}{{getMainCartTotal()}}</span></p>
