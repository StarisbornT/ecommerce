                        ...
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            <div class="form-check">
                                <input class="form-check-input shipping_method" type="radio" name="exampleRadios" id="exampleRadios1"
                                    value="{{$method->id}}" data-id="{{$method->cost}}" checked>
                            ...
                            <div class="terms_area">
                                <div class="form-check">
                                    <input class="form-check-input agree_terms" type="checkbox" value="" id="flexCheckChecked3"
                                        checked>
...
<script>
    $(document).ready(function() {
        ...
        $('.shipping_method').on('click', function() {
           ...
           $('#total_amount').text("{{$setting->currency_icon}}"+totalAmount)
        })
        ...
        $('#submitCheckOutForm').on('click', function(e) {
            ...
            }else if(!$('.agree_terms').prop('checked')) {
                toastr.error('You have to agree to website terms and condition')
            }
            else {
                $.ajax({
