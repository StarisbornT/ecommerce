                    ...
                    <div class="">
                        <div class="wsus__invoice_area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-4">
                                            <div class="wsus__invoice_single text-md-end">
                                                ...
                                                <p>Transaction: {{$order->transaction->transaction_id}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td class="name">
                                                    ...
                                                    <span>{{$key}} : {{$item->name}} ({{$setting->currency_icon}} {{$item->price}})</span>
                            ...
                            <div class="wsus__invoice_footer">
                                ...
                                <p><span>Coupon(-):</span> {{$setting->currency_icon}} {{@$coupon->discount_value == null ? 0 : $coupon->discount_value}} </p>
