            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{route('admin.products-variant-item.create',
                    ['productId' => $product->id, 'variantId' => $variant->id])}}" class="btn btn-primary"><i class="bi bi-plus-circle"></i>Create Variant</a>
                </div>
              </div>
              <div class="card-body">
                {{$dataTable->table()}}
