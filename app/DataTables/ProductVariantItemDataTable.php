...
class ProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query) {
            $editBtn = '<a href="'.route('admin.products-variant-item.edit', $query->id).'" class="btn btn-primary"><i class="bi bi-pen-fill"></i></a>';
            $deleteBtn = '<a href="'.route('admin.products-variant-item.destroy', $query->id).'" class="btn btn-danger delete-item ml-1"><i class="bi bi-trash-fill"></i></a>';
