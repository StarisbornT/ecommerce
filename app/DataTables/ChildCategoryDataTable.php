...
class ChildCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query) {
            $editBtn = '<a href="'.route('admin.child-category.edit', $query->id).'" class="btn btn-primary"><i class="bi bi-pen-fill"></i></a>';
            $deleteBtn = '<a href="'.route('admin.child-category.destroy', $query->id).'" class="btn btn-danger delete-item"><i class="bi bi-trash-fill"></i></a>';
