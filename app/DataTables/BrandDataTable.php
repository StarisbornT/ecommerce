    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
                $editBtn = '<a href="'.route('admin.brand.edit', $query->id).'" class="btn btn-primary"><i class="bi bi-pen-fill"></i></a>';
                $deleteBtn = '<a href="'.route('admin.brand.destroy', $query->id).'" class="btn btn-danger delete-item"><i class="bi bi-trash-fill"></i></a>';
