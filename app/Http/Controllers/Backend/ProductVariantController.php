...
class ProductVariantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $variant->products_id = $request->product;
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.products.products-variant.edit', compact('variant'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response(['status' => 'error', "message" => "This variant contains item, Delete variant items first"]);
