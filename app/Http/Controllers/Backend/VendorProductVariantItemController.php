...
class VendorProductVariantItemController extends Controller
{
    public function index(VendorProductVariantItemDataTable $dataTable, $productId, $variantId){
        ...
        return $dataTable->render('vendor.product.products-variant-item.index', compact('product', 'variant'));
       }
       ...
       public function create(string $productId, string $variantId) {
           ...
           return view('vendor.product.products-variant-item.create', compact('variant', 'product'));
       }
       ...
       public function edit(string $variantItemId) {
           ...
           return view('vendor.product.products-variant-item.edit', compact('variantItem'));
       }
